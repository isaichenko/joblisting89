...
Job.create!(title: "Process Engineer", job_type_id: 1, job_area_id: 1, salary_min: 5000, salary_max: 5500, hires: 1, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 3, education_id: 1, user_id: 1, expiry_date: Time.now + 30.days)
...
Job.create!(id: 11,title: "Senior Piping Engineer", job_type_id: 1, job_area_id: 1, salary_min: 6500, salary_max: 75000, hires: 2, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 4, education_id: 4, user_id: 2, expiry_date: Time.now + 30.days)
...
Job.create!(id: 16,title: "Finance Manager", job_type_id: 1, job_area_id: 3, salary_min: 9000, salary_max: 10000, hires: 1, description: "Taking care of all the finances activities", email: "", address: "", experience: 5, education_id: 3, user_id: 7, expiry_date: Time.now + 30.days)
...
Resume.create!(first_name: "Mike", last_name: "Tison", country: "Ukraine", city: "Poltava", contact_information: "taison@gmail.com",
  ...
  awards_attributes: [{title: "Oscar", date_awarded: "2017-06-05", description: "Best Actor"}],
